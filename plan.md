...
- Published HEAD before this batch: `4666003`
  (`registerize fixed CRC update runners`).
- Current candidate coverage: **2011/2185 (92.04%)**.
- Remaining fallback population: **174 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 174 final-cost fallbacks,
