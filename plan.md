...
- Published HEAD before this batch: `17cd90f`
  (`schedule backward record searches`).
- Current candidate coverage: **1924/2185 (88.05%)**.
- Remaining fallback population: **261 `final-cost-policy`**, with no other
  fallback reason.
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 261 final-cost fallbacks,
