...
- Published HEAD before this batch: `65a3929`
  (`schedule IEEE NaN bit tests`).
- Current candidate coverage: **1977/2185 (90.48%)**.
- Remaining fallback population: **208 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 208 final-cost fallbacks,
