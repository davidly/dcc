...
- Published HEAD before this batch: `68d8c6f`
  (`schedule deterministic struct pointer reports`).
- Current candidate coverage: **2037/2185 (93.23%)**.
- Remaining fallback population: **148 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 148 final-cost fallbacks,
