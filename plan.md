...
- Published HEAD before this batch: `19bd213`
  (`schedule closed sort search reports`).
- Current candidate coverage: **2056/2185 (94.10%)**.
- Remaining fallback population: **129 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 129 final-cost fallbacks,
