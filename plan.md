...
- Published HEAD before this batch: `f713b86`
  (`schedule by-value slice reductions`).
- Current candidate coverage: **1905/2183 (87.27%)**.
- Remaining fallback population: **278 `final-cost-policy`**, with no other
  fallback reason.
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 278 final-cost fallbacks,
