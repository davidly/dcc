...
- Published HEAD before this batch: `0824459`
  (`schedule IEEE special value checks`).
- Current candidate coverage: **2068/2185 (94.65%)**.
- Remaining fallback population: **117 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 117 final-cost fallbacks,
