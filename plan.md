...
- Published HEAD before this batch: `367a54f`
  (`schedule compact conditional contexts`).
- Current candidate coverage: **1913/2185 (87.55%)**.
- Remaining fallback population: **272 `final-cost-policy`**, with no other
  fallback reason.
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 272 final-cost fallbacks,
