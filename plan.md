...
- Published HEAD before this batch: `b9e5801`
  (`schedule sequential unary reports`).
- Current candidate coverage: **1926/2185 (88.15%)**.
- Remaining fallback population: **259 `final-cost-policy`**, with no other
  fallback reason.
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 259 final-cost fallbacks,
