...
- Published HEAD before this batch: `fdadd8a`
  (`schedule fixed file line loops`).
- Current candidate coverage: **1992/2185 (91.17%)**.
- Remaining fallback population: **193 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 193 final-cost fallbacks,
