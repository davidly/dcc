...
- Published HEAD before this batch: `89e8229`
  (`schedule corrected CPI reporters`).
- Current candidate coverage: **2001/2185 (91.58%)**.
- Remaining fallback population: **184 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 184 final-cost fallbacks,
