...
- Published HEAD before this batch: `7c1e5b7`
  (`schedule scaled global loads`).
- Current candidate coverage: **1994/2185 (91.26%)**.
- Remaining fallback population: **191 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 191 final-cost fallbacks,
