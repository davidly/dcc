...
- Published HEAD before this batch: `124ab17`
  (`schedule dynamic global array fma`).
- Current candidate coverage: **1952/2185 (89.34%)**.
- Remaining fallback population: **233 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 233 final-cost fallbacks,
