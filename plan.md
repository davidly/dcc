...
- Published HEAD before this batch: `329235a`
  (`schedule wide bitcast calls`).
- Current candidate coverage: **1953/2185 (89.38%)**.
- Remaining fallback population: **232 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 232 final-cost fallbacks,
