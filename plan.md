...
- Published HEAD before this batch: `db87958`
  (`enable unsigned byte reports`).
- Current candidate coverage: **2002/2185 (91.62%)**.
- Remaining fallback population: **183 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 183 final-cost fallbacks,
