...
- Published HEAD before this batch: `d4914e3`
  (`registerize fixed record row sums`).
- Current candidate coverage: **2012/2185 (92.08%)**.
- Remaining fallback population: **173 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 173 final-cost fallbacks,
