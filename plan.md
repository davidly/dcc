...
- Published HEAD before this batch: `1001b17`
  (`schedule fixed static byte scans`).
- Current candidate coverage: **2005/2185 (91.76%)**.
- Remaining fallback population: **180 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 180 final-cost fallbacks,
