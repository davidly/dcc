...
- Published HEAD before this batch: `caf9a11`
  (`schedule wide hash loops`).
- Current candidate coverage: **1993/2185 (91.21%)**.
- Remaining fallback population: **192 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 192 final-cost fallbacks,
