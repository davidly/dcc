...
- Published HEAD before this batch: `73d688c`
  (`schedule random unique initialization`).
- Current candidate coverage: **1976/2185 (90.43%)**.
- Remaining fallback population: **209 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 209 final-cost fallbacks,
