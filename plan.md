...
- Published HEAD before this batch: `9f027be`
  (`schedule reduced float polynomials`).
- Current candidate coverage: **1935/2185 (88.56%)**.
- Remaining fallback population: **250 `final-cost-policy`**, with no other
  fallback reason.
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 250 final-cost fallbacks,
