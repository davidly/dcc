...
- Published HEAD before this batch: `afd02b7`
  (`schedule nested conditional selections`).
- Current candidate coverage: **1915/2185 (87.64%)**.
- Remaining fallback population: **270 `final-cost-policy`**, with no other
  fallback reason.
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 270 final-cost fallbacks,
