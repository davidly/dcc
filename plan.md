...
- Published HEAD before this batch: `20e0484`
  (`schedule packed bit decoders`).
- Current candidate coverage: **2055/2185 (94.05%)**.
- Remaining fallback population: **130 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 130 final-cost fallbacks,
