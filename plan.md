...
- Published HEAD before this batch: `48d79de`
  (`schedule flagged record appends`).
- Current candidate coverage: **2069/2185 (94.69%)**.
- Remaining fallback population: **116 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 116 final-cost fallbacks,
