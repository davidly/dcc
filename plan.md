...
- Published HEAD before this batch: `b9ae87d`
  (`generalize conditional integer selection`).
- Current candidate coverage: **1925/2185 (88.10%)**.
- Remaining fallback population: **260 `final-cost-policy`**, with no other
  fallback reason.
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 260 final-cost fallbacks,
