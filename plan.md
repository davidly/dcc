...
- Published HEAD before this batch: `db644a0`
  (`schedule four byte failure checks`).
- Current candidate coverage: **2067/2185 (94.60%)**.
- Remaining fallback population: **118 `final-cost-policy`**, all selected by
...
- The other statically smaller candidates are also false wins:
  ...
  (+28.46%/+31.34%).
- Current next priority: repeated causes in the 118 final-cost fallbacks,
