...
The comparison uses `tests/perf_baselines.csv` from this final working tree
against `upstream/main` at `950eaba92bbe0920252fdb3af89dee1680cd6bdd`.
Only the 355 applications present in both files are ranked. The branch adds 41
new regression applications and removes none; new applications are excluded
because main has no comparable baseline.
...
| Apps with average cycle improvement | 23 |
| Apps with average cycle regression | 236 |
| Apps with unchanged average cycles | 96 |
| Aggregate peep cycles | +0.269% |
| Aggregate nopeep cycles | +0.265% |
| Aggregate peep COM bytes | +8,832 (+0.315%) |
| Aggregate nopeep COM bytes | +6,784 (+0.237%) |
| Mean per-app peep cycle change | +0.845% |
| Mean per-app nopeep cycle change | +0.805% |
| Mean per-app average cycle change | +0.825% |
| Mean average change among improved apps | -2.691% |
| Mean average change among regressed apps | +1.503% |

### Most improved applications

Only 23 common applications have a lower average cycle baseline, so this table
...
| 2 | `sieve` | -7.144% | -4.770% | -9.517% | -876,898 | -1,820,888 | -128/-128 |
| 3 | `texec` | -6.538% | -6.615% | -6.462% | -10,523 | -10,285 | +384/+384 |
| 4 | `tlmod` | -4.566% | -4.579% | -4.553% | -12,739 | -12,739 | -128/+0 |
| 5 | `tmuldiv` | -3.706% | -3.707% | -3.706% | -241,307 | -241,307 | -128/-128 |
| 6 | `tmatha` | -3.225% | -3.225% | -3.224% | -25,479 | -25,479 | +384/+384 |
| 7 | `tprintf` | -2.051% | -2.051% | -2.051% | -23,916 | -23,916 | +0/+0 |
| 8 | `pint` | -1.926% | -2.221% | -1.631% | -4,789,207 | -4,336,889 | +384/+384 |
| 9 | `cobint` | -1.316% | -1.446% | -1.185% | -9,549,357 | -9,993,073 | +384/+256 |
| 10 | `tpfinf` | -1.246% | -1.246% | -1.246% | -918 | -918 | +0/+0 |
| 11 | `tcptrarr` | -0.065% | -0.065% | -0.065% | -42 | -42 | -128/-128 |
| 12 | `tarresc` | -0.062% | -0.062% | -0.062% | -14 | -14 | -128/-128 |
| 13 | `tatan2sp` | -0.052% | -0.052% | -0.052% | -97 | -97 | +0/+0 |
| 14 | `tidxrmw` | -0.040% | -0.041% | -0.039% | -7 | -7 | -128/+0 |
| 15 | `tbyteeq` | -0.031% | -0.032% | -0.031% | -7 | -7 | +0/+0 |
| 16 | `tstrify` | -0.027% | -0.027% | -0.027% | -56 | -56 | -128/+0 |
| 17 | `tpreproc` | -0.019% | -0.019% | -0.019% | -98 | -98 | +0/+0 |
| 18 | `tfcarg2d` | -0.019% | -0.019% | -0.019% | -7 | -7 | +0/+0 |
| 19 | `tportio` | -0.019% | -0.019% | -0.019% | -7 | -7 | +0/+0 |
| 20 | `tforhex` | -0.014% | -0.014% | -0.014% | -7 | -7 | -128/-128 |
| 21 | `tbios` | -0.013% | -0.013% | -0.013% | -14 | -14 | +0/+0 |
| 22 | `tlcont` | -0.012% | -0.012% | -0.012% | -21 | -21 | +0/+0 |
| 23 | `tbdos` | -0.009% | -0.009% | -0.009% | -14 | -14 | -128/-128 |
...
| 3 | `a1` | +15.398% | +17.921% | +12.874% | +2,043,971 | +1,701,957 | -512/-1280 |
| 4 | `ttmp` | +14.409% | +14.414% | +14.404% | +9,619 | +9,619 | +384/+512 |
| 5 | `tscanin` | +12.964% | +12.970% | +12.958% | +7,671 | +7,671 | +0/+0 |
| 6 | `tfreopen` | +9.627% | +9.627% | +9.627% | +8,288 | +8,288 | +384/+384 |
| 7 | `tungetc` | +8.703% | +8.728% | +8.677% | +4,682 | +4,682 | +384/+512 |
| 8 | `tabort` | +7.578% | +7.593% | +7.564% | +4,237 | +4,224 | +128/+256 |
| 9 | `tfo` | +7.354% | +7.361% | +7.348% | +6,475 | +6,475 | +384/+512 |
| 10 | `tfmedge` | +6.792% | +6.792% | +6.792% | +26,140 | +26,140 | +0/-128 |
| 11 | `texfile` | +6.430% | +6.430% | +6.429% | +13,684 | +13,684 | +384/+384 |
| 12 | `tlongidx` | +6.396% | +6.399% | +6.393% | +3,248 | +3,248 | +0/+0 |
| 13 | `tfpos` | +6.241% | +6.247% | +6.235% | +5,120 | +5,120 | +384/+384 |
| 14 | `tfaedge` | +6.105% | +6.105% | +6.105% | +44,410 | +44,410 | +0/+0 |
| 15 | `trig` | +6.062% | +6.062% | +6.062% | +758,489 | +758,489 | +0/+0 |
| 16 | `tfio` | +5.235% | +5.237% | +5.233% | +7,529 | +7,529 | +512/+512 |
| 17 | `tfloat4` | +5.222% | +5.237% | +5.207% | +46,199 | +46,199 | -128/-128 |
| 18 | `tfopenw` | +4.823% | +4.827% | +4.820% | +3,401 | +3,401 | +512/+384 |
| 19 | `tc89ffio` | +4.787% | +4.788% | +4.787% | +5,611 | +5,611 | +0/+0 |
| 20 | `fileops` | +4.755% | +4.758% | +4.752% | +145,849 | +145,849 | +512/+512 |
| 21 | `tfeof` | +4.621% | +4.644% | +4.598% | +103,630 | +103,630 | +512/+512 |
| 22 | `trenamex` | +4.421% | +4.423% | +4.419% | +5,969 | +5,969 | +512/+640 |
| 23 | `tappend` | +4.349% | +4.349% | +4.348% | +9,118 | +9,118 | +512/+512 |
| 24 | `tpfio` | +4.165% | +4.168% | +4.161% | +16,078 | +16,078 | +128/+128 |
| 25 | `tlogfsp` | +4.044% | +4.045% | +4.044% | +6,204 | +6,204 | +0/+0 |
| 26 | `mm` | +3.958% | +3.962% | +3.954% | +4,844,476 | +4,844,548 | +0/-128 |
| 27 | `terrno` | +3.592% | +3.599% | +3.586% | +22,530 | +22,530 | +640/+640 |
| 28 | `tdrive` | +3.462% | +3.462% | +3.462% | +5,988 | +5,988 | +512/+512 |
| 29 | `tlog` | +3.454% | +3.454% | +3.454% | +35,509 | +35,509 | -128/-128 |
| 30 | `tioerr` | +3.438% | +3.438% | +3.437% | +8,270 | +8,270 | +512/+384 |
| 31 | `tlongfn` | +3.375% | +3.376% | +3.375% | +7,443 | +7,443 | +384/+384 |
| 32 | `tphi` | +3.333% | +3.333% | +3.333% | +35,647 | +35,647 | -128/-128 |
| 33 | `tstar` | +3.221% | +3.221% | +3.220% | +5,055 | +5,055 | +384/+384 |
| 34 | `trenwild` | +3.209% | +3.210% | +3.208% | +7,614 | +7,614 | +384/+384 |
| 35 | `trwold` | +3.198% | +3.198% | +3.197% | +2,864,592 | +2,864,592 | +256/+256 |
| 36 | `tctrlz` | +3.175% | +3.179% | +3.172% | +25,835 | +25,835 | +512/+384 |
| 37 | `trtl2` | +3.108% | +3.116% | +3.101% | +1,880 | +1,880 | +256/+384 |
| 38 | `tctype` | +3.058% | +3.058% | +3.058% | +709 | +709 | +0/+0 |
| 39 | `ttrig` | +3.031% | +3.033% | +3.029% | +1,226,701 | +1,226,701 | -128/-128 |
| 40 | `twild` | +3.020% | +3.020% | +3.019% | +8,334 | +8,334 | +384/+384 |
| 41 | `tc89fmul` | +2.928% | +2.928% | +2.928% | +572 | +572 | +0/+0 |
| 42 | `tdirpat` | +2.794% | +2.794% | +2.794% | +3,452 | +3,452 | +384/+384 |
| 43 | `tpflio` | +2.019% | +2.020% | +2.018% | +11,020 | +11,020 | +128/+128 |
| 44 | `tfmadd` | +1.794% | +1.795% | +1.793% | +7,000 | +7,000 | +0/-128 |
| 45 | `tfmaddr` | +1.771% | +1.771% | +1.771% | +1,425 | +1,425 | -128/-128 |
| 46 | `tpihexb` | +1.769% | +1.770% | +1.769% | +2,878 | +2,878 | +0/+0 |
| 47 | `tfmaf` | +1.767% | +1.767% | +1.767% | +1,838 | +1,838 | +0/+0 |
| 48 | `tasinfsp` | +1.748% | +1.748% | +1.748% | +2,275 | +2,275 | +0/+0 |
| 49 | `tctxops` | +1.732% | +1.741% | +1.724% | +1,807 | +1,807 | +0/+0 |
| 50 | `tpowfsp` | +1.726% | +1.726% | +1.726% | +3,783 | +3,783 | +0/+0 |
