...
## What dcc is
dcc has a C89 core plus target-appropriate C99/C11 front-end support. It takes a .c file and generates a .MAC assembly file that can be assembled by M80 and linked by L80 to produce CP/M .COM files.
