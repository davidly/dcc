...
- Latest continuation implementation:
  `ea8ec737` (`test: mutate byte matcher SSA edges`).
...
90,196/144,518 native branch outcomes (62.41%), and 158,971/169,867 regions
...
diagnostic modes are also covered. The raw ledger has 54,075 uncovered
...
SSA operand checks. The complete clobber manifest now contains 1,984
configurations.
