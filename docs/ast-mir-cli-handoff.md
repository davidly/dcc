...
- Latest continuation implementation:
  `4848e7d0` (`test: mutate multidimensional matcher`).
...
4,359/4,359 functions, 176,916/189,941 lines (93.14%),
90,301/144,518 native branch outcomes (62.48%), and 158,987/169,867 regions
...
diagnostic modes are also covered. The raw ledger has 53,970 uncovered
...
`t2darr` output. The complete clobber manifest now contains 2,360
configurations.
