...
- Latest continuation implementation:
  `c0f88530` (`test: mutate narrowed divmod matcher`).
...
4,359/4,359 functions, 176,927/189,942 lines (93.15%),
90,428/144,518 native branch outcomes (62.57%), and 158,996/169,867 regions
(93.60%). The preflight matrix covers
...
diagnostic modes are also covered. The raw ledger has 53,843 uncovered
...
preserves all 66 `tdmfuse` checks through generic selection. The complete
clobber manifest now contains 2,864 configurations.
