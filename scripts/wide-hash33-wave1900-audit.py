#!/usr/bin/env python3
"""Exhaustively audit the retained wide-hash33 exact schedule."""
...
FUNCTION = "wide_hash33"
RENAMED_FUNCTION = "wide_hash33_renamed"
SOURCE = "tests/mir-clobber/whash33.c"
TEMPLATE = "wide-hash33"
FORCED_CANDIDATE = "spilled-phi-slot"
INSTRUCTION_COUNT = 32
BASELINE_SHA256 = (
    "bf0ced071ba71d9e4ff2a9f109a80ef9d2fa1d1f925e285ceeaad241f0a11ec0"
)
BASELINE_SELECTED_HASH = "4fd89752"
EXPECTED_RUNTIME = (
    "wide hash33 failures=0 "
    "values=0,108966,2634864069,95184653,282009",
)
...
REJECT_REASON = re.compile(
    ...
    r"template=wide-hash33 reject=(?P<reason>\S+)"
)
...
SOURCE_CONTROLS = (
    SourceControl("baseline", "WH19BASE", expect_exact=True),
    SourceControl(
        "renamed-function", "WH19RF", ("WIDEHASH33_RENAMED",),
        RENAMED_FUNCTION, expect_exact=True,
    ),
    SourceControl(
        "renamed-locals", "WH19RL", ("WIDEHASH33_RENAMED_LOCALS",),
        expect_exact=True,
    ),
    SourceControl(
        "volatile-text", "WH19VT", ("WIDEHASH33_VOLATILE_TEXT",),
        expected_reject="semantic-payload",
    ),
    SourceControl(
        "alternate-flow", "WH19AF", ("WIDEHASH33_ALT_FLOW",),
...
IDENTITY_INSTRUCTIONS = (1, 4, 6, 7, 8, 14, 17, 20, 26, 30)
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        default="build/wide-hash33-wave1900-audit",
    )
    ...
    print(
        f"wide hash33 Wave 1900 mutations={len(mutation_rows)} "
        f"{outcomes}"
    )
